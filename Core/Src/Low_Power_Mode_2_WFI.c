...
/*
 * Low power mode WFI and WFE instructions
 * */
#include"main.h"
...
char button_Pressed_Message[20] = "Button Pressed \r\n";
...
void GPIO_Init(void) {
	...
	__HAL_RCC_GPIOA_CLK_SLEEP_DISABLE(); // going to LPM
	...
	switchGpio.Mode = GPIO_MODE_IT_RISING;
